...
<div class="section slider-section">
    ...
    <!-- Slider Section Start -->
    <div class="single-slider" style="background-image: url(<?= ASSETS . THEME ?>/images/slider/slider-bg.jpg);">
        <div class="container">
        ...
        <div class="slider-images">
            <div class="image" data-aos="fade-left" data-aos-delay="1000">
                <img src="<?= ASSETS . THEME ?>/images/slider/slider-2.png" alt="Slider">
            </div>
        </div>
        <!-- Slider Images End -->
        ...
        <div class="slider-images-02">
            <div class="image" data-aos="fade-right" data-aos-delay="1300">
                <img src="<?= ASSETS . THEME ?>/images/slider/slider-1.png" alt="Slider">
            </div>
        </div>
        <!-- Slider Images End -->
    </div>
        ...
        <div class="about-wrapper">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-images">
                        <div class="images" data-aos="fade-right" data-aos-delay="200">
                            <img src="<?= ASSETS . THEME ?>/images/about/about.png" alt="About">
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="about-content" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <p>A manutenção de um carro enfrenta racionalmente consequências extremamente dolorosas. Também não há ninguém que ame ou siga um exemplo trivial, quem de nós empreende escolhe</p>
                    <p> </p>
...
<div class="section ">
    <div class="container">
        <div class="section-padding-02 position-relative">
            ...
            <img class="services-shape" src="<?= ASSETS . THEME ?>/images/service/services.png" alt="Service">
