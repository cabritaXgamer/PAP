        ...
        <div class="page-banner-wrapper">
            ...
            <div class="page-banner-content">
                ...
                <div class="section-title">
                    ...
                    <h2 class="main-title">Os nossos serviços</h2>
                </div>
                <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="about-images images-03 pt-5" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <div class="exprience" data-aos="fade-up" data-aos-delay="400">
                            <p><strong>30 </strong>anos de experiencia</p>
                        </div>
                    </div>
                    <!-- About Images End -->
                </div>
                <div class="col-lg-5">
                    ...
                    <div class="about-content" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h5 class="sub-title">Bem vindo a <strong>Cilindrenvolvente</strong>.</h5>
...
<div class="section ">
    <div class="container">
        <div class="section-padding-02 position-relative">
            ...
            <img class="services-shape" src="<?= ASSETS . THEME ?>/images/service/services1.png" alt="Service">
