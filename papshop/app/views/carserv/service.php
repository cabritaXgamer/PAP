...
<body>
            ...
            <div class="container">
                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-images">
                        <img src="<?= ASSETS . THEME ?>/images/page-banner.png" alt="Page Banner">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="about-images images-03 pt-5" data-aos="fade-right" data-aos-delay="200">
                                <div class="images">
                                    <img src="<?= ASSETS . THEME ?>/images/about/about-3.png" alt="About">
                                </div>
    ...
    <div class="section section-padding-02">
        <div class="container">
            ...
            <div class="call-to-action-wrapper">
                ...
                <div class="call-to-action-images" style="background-image: url(<?= ASSETS . THEME ?>/images/call-to-action-bg.jpg);"></div>
    ...
    <!-- <div class="single-blog" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="blog-content">
                                <ul class="meta">
                                    <li> <i class="fa fa-calendar"></i> 28 May, 2021</li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="single-brand">
                                <img src="<?= ASSETS . THEME ?>/images/brand/brand-01.png" alt="Brand">
                            </div>
                            <!-- Single Brand End -->
                        ...
                        <div class="swiper-slide">
                            ...
                            <!-- Single Brand Start -->
                            <div class="single-brand">
                                <img src="<?= ASSETS . THEME ?>/images/brand/brand-02.png" alt="Brand">
                            </div>
                            <!-- Single Brand End -->
                        ...
                        <div class="swiper-slide">
                            ...
                            <!-- Single Brand Start -->
                            <div class="single-brand">
                                <img src="<?= ASSETS . THEME ?>/images/brand/brand-03.png" alt="Brand">
                            </div>
                            <!-- Single Brand End -->
                        ...
                        <div class="swiper-slide">
                            ...
                            <!-- Single Brand Start -->
                            <div class="single-brand">
                                <img src="<?= ASSETS . THEME ?>/images/brand/brand-04.png" alt="Brand">
                            </div>
                            <!-- Single Brand End -->
