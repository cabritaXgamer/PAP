...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?= ASSETS . ADMIN_THEME ?> /css/bootstrap.css" rel="stylesheet">
    <!-- papshop\public\assets\admin -->
    <!--external css-->
    <link href="<?= ASSETS . ADMIN_THEME ?> /font-awesome/css/font-awesome.css" rel="stylesheet" />
    ...
    <link href="<?= ASSETS . ADMIN_THEME ?> /css/style-responsive.css" rel="stylesheet">

    <script src="<?= ASSETS . ADMIN_THEME ?> /js/chart-master/Chart.js"></script>
